...
const MyProjects = () => {
  ...
  return (
    <div className=" m-2 flex-1 flex flex-col backdrop-blur-md bg-white/10 dark:bg-zinc-900/30 border border-border rounded-xl overflow-hidden">
      {/* Header */}
