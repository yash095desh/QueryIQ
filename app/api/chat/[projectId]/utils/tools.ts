...
export function createDatabaseTools(dbUrl: string) {
  return {
...
export function getSystemPrompt(dbSummary: string) {
  return `You are a helpful database assistant for a project with the following details:
